...
Copy the content of the table just written in your home directory "variants_to_VEP.txt" and paste in [VEP](https://www.ensembl.org/Homo_sapiens/Tools/VEP). Run and save results obtained as "TXT". Upload those results in the home like you did for the vcf file.
...
vepped_variants <- "vepped_variants.txt" ### replace with the vepped .txt output
VEP.res <- read.table(vepped_variants, header = T, sep ='\t',comment.char = "") # the file name is randomly chosen when you download it from VEP
...
write.table(selectedVars_table, "prioritized_variants.txt", row.names = F, quote = FALSE)
```
