...
# Result summary
The variant _<chr:start:ref:alt>_ has been prioritized...
...
- The reads from FASTQ files were processed by ..., using the Human Reference Genome ...
...
- The ### R package was used to perform the Differential Expression (DE) analysis, and identify the list of de-regulated genes when comparing **treaments vs controls**.
...
-   The reads from FASTQ files were alygned by ..., using the Human Reference Genome ...

-   ### was used to perform the variant calling.
-   ...

The following code was used to filter and prioritise the variantions, based on the annotations ...:
...
You can show the biological consequences of identified mutations by a plot
...
You can add more information about the prioritized variant(s), such as clinvar significance, variant allele frequency from gnomAD database, ... 
