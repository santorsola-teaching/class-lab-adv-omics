...
# Dataset conditions, e.e. cases/controls
...
tx2gene <- read_tsv("/home/rstudio/data/results/salmon/salmon_tx2gene.tsv", col_names = FALSE, show_col_types = FALSE)
tx2gene$X2 <- paste(tx2gene$X2, tx2gene$X3, sep='_')


# Read quant files from salmon

files <- file.path("/home/rstudio/data/results/salmon", dataset$sample, "quant.sf")
...
dev.off() #the most de-regulated gene woithin the dataset
...
# Select the significant genes by padj
